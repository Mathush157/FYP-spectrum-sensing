function [txWaveInt, waveinfo] = helperSpecSenseLTESignal(RC,timeShift,TrBlkOff,numSF,outputFs, modulationType)
...
% Apply modulation type for LTE
rmc.PDSCH.Modulation = {modulationType};  % Apply modulation type
