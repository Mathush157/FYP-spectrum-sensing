...
function [txWaveInt, dlWaveInfo] = helperSpecSenseNRSignal(scs,chBW,SSBPeriod,timeShift,numSF,outputFs, modType)
...
cfgDL = specSenseNRConfig(chBW,scs,startGrid,SSBPeriod,numSF);
 cfgDL.PDSCH{1}.Modulation = modType;
% Generate waveform
